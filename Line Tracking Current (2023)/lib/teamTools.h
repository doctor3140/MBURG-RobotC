...
int obstacleWidth = 20; //How far it needs to go to move around each side of the obstacle
int obstacleDist = 15; //How close to get to the obstacle

bool hasObstacle = false; //is there an obstalce
...
void setObStacleDist(int obDist){
	obstacleDist=obDist;
}
